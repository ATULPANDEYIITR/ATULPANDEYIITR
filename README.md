...
<style>
    ...
    .career-heading {
        ...
        /* Main animation */
        animation:
            textJourney 5s linear infinite,
            rainbowFlow 2.5s linear infinite,
            glitter 1.2s ease-in-out infinite;

        filter:
            drop-shadow(0 0 5px rgba(255, 0, 170, 0.8))
            drop-shadow(0 0 12px rgba(0, 200, 255, 0.6))
            drop-shadow(0 0 22px rgba(255, 230, 0, 0.4));
    }

    /*
       Text travels from RIGHT → LEFT,
       disappears completely,
       then emerges again from the RIGHT.
    */
    @keyframes textJourney {
    ...
    /* Continuously moving rainbow colors */
    ...
    @keyframes glitter {
        ...
        0% {
            filter:
                drop-shadow(0 0 4px #ff0080)
                drop-shadow(0 0 8px #00c8ff);
        }

        25% {
            filter:
                drop-shadow(0 0 7px #ffe600)
                drop-shadow(0 0 15px #ff0080)
                drop-shadow(0 0 25px #7a5cff);
        }
